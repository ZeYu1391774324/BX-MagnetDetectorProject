...
#include "transferbx_28.h"

void transferbx_28::initParameter()
{
	...
	coedata.coe_circum_angle = 0.01;       //姿态周向角   轨迹测绘的当量是0.01
...
void transferbx_28::DatTransTxt_bx(char file_name[], unsigned char Data[], FILE * fp)
{
	int  n;
	int i, j, p, q;
	...
	//***********************************其他数据***************************************//
	//轨迹测绘
	data_array[n++] = (short int)(uchar_int16(&Data[208], LSB_FIRST))*coedata.coe_circum_angle; //周向角 
	data_array[n++] = (short int)(uchar_int16(&Data[206], LSB_FIRST))*coedata.coe_dip_angle;     //倾角
	data_array[n++] = (short int)(uchar_int16(&Data[210], LSB_FIRST))*coedata.coe_raw_angle;     //航向角
	...
	data_array[n++] = (short int)(uchar_int16(&Data[202], LSB_FIRST))*coedata.coe_accleration;   //Z轴加速度
																				//接口板温度
...
void transferbx_28::DatTransTxt_bx_password(char file_name[], unsigned char Data[], FILE * fp)
{
}
