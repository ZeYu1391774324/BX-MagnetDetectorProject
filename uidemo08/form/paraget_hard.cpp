...
ParaGet_hard::ParaGet_hard(QString type,QString size,int encryptFlag)
{
    ...
    case 1:                     //变形
        ...
        case 1:                 //8inch变形
            ...
            dataPara.data37_54_start=0;
            dataPara.data37_54_len=0;
            ...
            */
            ...
            addData.accX_start=318;
            addData.accX_len=4;
            addData.accX_para=0.0029;
            addData.accY_start=322;
            addData.accY_len=4;
            addData.accY_para=0.0029;
            addData.accZ_start=326;
            addData.accZ_len=4;
            addData.accZ_para=0.0029;
            addData.status_start=352;
            addData.status_len=2;
    ...
    case 2:                     //漏磁
        ...
        case 3:            //12inch漏磁
        {
            ...
            frameLength_hard=1160*2;


            // 数据部分参数
            dataPara_MFL.MFLData_start=80;
            dataPara_MFL.MFLData_end=2142;
            dataPara_MFL.MFLData_num=24;
            dataPara_MFL.MFLData_len=43*2;


            //环境温度参数,处理板温度参数,姿态温度参数
            tempData.tempEnvir_start=60;
            tempData.tempEnvir_len=4;
            tempData.tempPanel_start=2144;
            tempData.tempPanel_len=4;
            tempData.tempPos_start=2258;
            tempData.tempPos_len=4;
            tempData.envirPara1=193.23;
            tempData.envirPara2=0.23;
            tempData.panelPara=0.0625;
            tempData.positionPara=1;

            //里程参数
            disData.opt_start=8;
            disData.opt_len=8;
            if(encrypted){
                disData.dis1_start=2288;
                disData.dis1_len=8;
                disData.dis2_start=2296;
                disData.dis2_len=8;
                disData.dis3_start=2304;
                disData.dis3_len=8;
            }
            else {
                disData.dis1_start=2288;
            ...
            //姿态周向角，倾角，航向角，加速度
            posData.ZXJ_start=2238;
            posData.ZXJ_len=4;
            posData.QJ_start=2242;
            posData.QJ_len=4;
            posData.HXJ_start=2262;
            posData.HXJ_len=4;
            posData.ZXJpara=0.1;
            posData.QJpara=0.1;
            posData.HXJpara=0.1;
