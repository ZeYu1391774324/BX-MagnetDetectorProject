...
CollectByTimePanel::CollectByTimePanel(QWidget *parent, QSerialPort *serial, ParaGet *para) :
    QWidget(parent),
...
void CollectByTimePanel::initPanel_MFL(){
    // initiate buttons
    // Collect by time start button
    connect(ui->CollectByTime_StartBtn,&QPushButton::clicked,[=](){serial->write(QByteArray::fromHex(QString(COLLECTBYTIMEFRAME).toLatin1().data()));});
    // Collect by time stop button
...
void CollectByTimePanel::initPlots_MFL(){
    // 每个图表中绘制6条曲线
...
void CollectByTimePanel::updatePlots_MFL(){
...
//        switch (i) {
//        case 0:
//            ui->CollectByTimePlot1->graph(i)->setData(X,Y1);
//            break;
//        case 1:
//            ui->CollectByTimePlot1->graph(i)->setData(X,Y2);
//            break;
//        case 2:
//            ui->CollectByTimePlot1->graph(i)->setData(X,Y3);
//            break;
//        case 3:
//            ui->CollectByTimePlot1->graph(i)->setData(X,Y4);
//            break;
//        case 4:
//            ui->CollectByTimePlot1->graph(i)->setData(X,Y5);
//            break;
//        case 5:
//            ui->CollectByTimePlot1->graph(i)->setData(X,Y6);
//            break;
//        default:
//            break;
//        }
...
void CollectByTimePanel::updateMFLData(QList<double> newMFLData){
    // 数据更新
